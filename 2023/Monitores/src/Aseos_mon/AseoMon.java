...
public class AseoMon {
	...
	//private boolean limpiando;//true sii equipo de limpieza dentro
	//justa
	private boolean tocaLimpiar;//true sii equipo quiere limpiar
	...
	public synchronized void entraCliente(int id) throws InterruptedException {
		//CS: no puede entrar si estan limpiando(+justicia: toca limpiar)
		while(tocaLimpiar) {
			wait();
		}
		numClientes++;
	...
	public synchronized void saleCliente(int id) {
		numClientes--;
		if(numClientes==0) {

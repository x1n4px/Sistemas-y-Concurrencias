...
int main(){
	...
	importarPasajerosVagon("/home/in4p/git/Sistemas-y-Concurrencias/PSC2023/PreparacionExamenJunio2023/Septiembre 2022 -  Enunciado y esqueletos-C/C/vagon0.bin",tren,0);
	importarPasajerosVagon("/home/in4p/git/Sistemas-y-Concurrencias/PSC2023/PreparacionExamenJunio2023/Septiembre 2022 -  Enunciado y esqueletos-C/C/vagon1.bin",tren,1);
    printf("Imprime tren post abrir lista:\n");
    imprimeTren(tren,maximoVagones);

    printf("Almacena en fichero\n");

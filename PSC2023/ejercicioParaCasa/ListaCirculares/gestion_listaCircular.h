#ifndef _GESTION_LISTA_CIRCULAR_
#define _GESTION_LISTA_CIRCULAR_


//Una lista circular, es una lista cuyo "último elemento apunta al primero". Permite mover la cabeza hacia delante y mantener toda la lista enlazada de forma automática.
...
/**
 * @brief Se avanza la cabeza de la lista @p numero_rotaciones veces. 
 * @param ptr_lista 
 * @param numero_rotaciones 
 * @param ok 
 */
void rotarCabeza(ptr_lista_entero * ptr_lista, int numero_rotaciones, int *ok);

/**
 * @brief Inserta el elemento @p valor en la cabeza de la lista @p ptr_lista, recuerda actualizar el último para que apunte al nuevo primero.
...
/**
 * @brief Intenta extraer los @p n primeros elementos de la @p ptr_lista, en @p m indica cuántos a podido extraer. Los extraidos también son lista circular.

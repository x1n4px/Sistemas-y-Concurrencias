...
int main(int argc, char const *argv[])
{
    ...
    assert(lista->sig->sig->sig->sig==lista);
    assert(ok==1);
    ...
    assert(lista->sig->sig->sig->sig->sig->sig==lista);
    assert(ok==1);
    ...
    assert(lista_extraidos->sig->numero==1);
    assert(lista->numero==2);
    assert(lista->sig->sig->sig->sig->sig->numero==2);
    assert(ex==1);
    ...
    assert(lista_extraidos->sig->sig->numero==2);
    assert(ex==2);
    ...
    assert(lista_extraidos->sig->sig->sig->numero==4);
    assert(ex==3);
    ...
    rotarCabeza(&lista,2,&ok);
    assert(lista->numero==3);
    assert(lista->sig->numero==4);
    assert(lista->sig->sig->numero==5);
    assert(lista->sig->sig->sig->numero==6);
    assert(lista->sig->sig->sig->sig->numero==1);
